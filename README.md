...
[![Checks](https://img.shields.io/badge/checks-802%20passing-brightgreen)](tests/)
...
full suite of **802 automated checks** (778 tests plus 24 evals) runs offline with no API key and no network, including the
